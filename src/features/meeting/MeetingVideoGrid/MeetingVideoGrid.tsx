...
export const MeetingVideoGrid: FC<MeetingVideoGridProps> = ({ participants, onClick }) => {
  return (
    <div className={styles.grid} onClick={onClick}>
      <video src="/video/cat.webm" autoPlay muted loop className={styles.video} />
      <div className={cn(styles.participants, styles[`participants-${participants.length}`])}>
